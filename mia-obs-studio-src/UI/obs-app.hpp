...
public:
	...
	QString GetMiaAppName() const;
	QString GetMiaCourseName() const;
	void SetMiaCourseName(const QString name);
	QString GetMiaLoginGuid() const;
	QString GetMiaLoginUid() const;
	QString GetMiaLoginToken() const;
	void SetMiaLogin(const QString& guid, const QString& uid, const QString& token);
	MiaObsServerConf* GetMiaObsServerConf();
