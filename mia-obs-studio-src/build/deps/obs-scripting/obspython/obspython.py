...
def obs_proprety_text_type(p: 'obs_property_t *') -> "enum obs_text_type":
    return _obspython.obs_proprety_text_type(p)
obs_proprety_text_type = _obspython.obs_proprety_text_type
